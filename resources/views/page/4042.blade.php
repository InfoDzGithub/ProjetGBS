...
<head>
  ...
  <link rel="stylesheet" href="{{asset('frontEnd')}}/assets/css/4042.css">
</head>
<body>
<!-- partial:index.partial.html -->
  <div id="wrap">
    ...
    <div id="main-content">
      ...
      <div id="navigation">
        <a class="navigation" href="/profil">Home</a><a class="navigation" href="">About
        Us</a>
...
<script  src="{{asset('frontEnd')}}/assets/js/4042.js"></script>
