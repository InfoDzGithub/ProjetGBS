                            ...
                            <div class="panel panel-default" >
                                ...
                                <div id="collapse{{$Ex->id}}" class="panel-collapse panel-ic collapse in">
                                    <div class="panel-body admin-panel-content animated bounce" style="background-color: #87c1ea1c;box-shadow: 0px 11px 6px 2px #f2f8fd;">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="box box-3">
                                                <a href="{{ url('affectation/'.$Ex->id)}}">
                                                    <div class="cover" style="position:relative; height:150px">
                                                         <div style="position:absolute;z-index:1">
                                                            <img src="{{asset('frontEnd')}}/img/Calque1.png" alt="" style="width: 190px;height: 160px;">
                                                         </div>
                                                         <div style="position:absolute;top: 80px;width: 160px;height: 100px;z-index: 3;font-size:150%;">
                                                            <center><b style="text-shadow: -6px -5px 4px #404040ad;">affectation</b></center>
                                                         </div> 
                                                    </div>
                                                    
                                                    <button type="button" class="But" data-dismiss="modal" data-toggle="tab" href="#sendmail"><div></div>
                                                    </button>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="box box-4">
                                                ...
                                                <a href="{{ url('paquet/'.$P->idP.'/'.$Ex->id)}}">
                                                    @elseif(Auth::user()->type == 'ER' || Auth::user()->type == 'EN')
                                                    <a href="{{ url('CorrectionPaquet/'.$P->idP.'/'.$Ex->id)}}">
