            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="all-form-element-inner">
                        <form action="{{url('enseignants')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div class="bt-df-checkbox pull-left">
                                           <div class="row">
                                             <div class="col-lg-12">
                                               <div class="i-checks pull-left">
                                               <label><input type="radio" value="EN" name="role"> <i></i> Enseignant Normal </label>
                                               </div>
                                             </div>
                                           </div>
                                        <div class="row">
                                           <div class="col-lg-12">
                                             <div class="i-checks pull-left">
                                             <label>
                                             <input type="radio" checked="" value="ER" name="role"> <i></i> Enseignant Responsable</label>
                                             </div>
                                           </div>
                                        </div>
                                        </div>
                           ...
                           <div class="form-group-inner">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                       <select data-placeholder="Choose a Country..." name="grade" class="chosen-select" tabindex="-1">
                                        <option value="">Select Module</option>
                                        <option value="United States">module1</option>
                                        <option value="United Kingdom">module2</option>
                                        <option value="Afghanistan">module3</option>
                                        <option value="Aland Islands">module3</option>
                                        <option value="Albania">module4</option>
                                        <option value="Algeria">module5</option>
                                        <option value="American Samoa">module6</option>
                                        <option value="Andorra">module7</option>
                                        <option value="Angola">module8</option>
                                        <option value="Anguilla">module9</option><option value="Antarctica">module
                                        </option>
                                    </select>
                                    </div>
                                </div>
