...
@section('title','GBS | details De l'Admin')
@section('cssHeader')
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 center">
                                                <span class="profile-picture">
                                                    <img class="editable img-responsive" alt="Alex's Avatar" src="{{asset($admin->photo)}}" />
                                                </span>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <h4 class="blue">
                                                    <span class="middle">{{$admin->name}} {{$admin->prenom}}</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 center">
                                                <span class="profile-picture">
                                                    ...
                                                    class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="{{asset($admin ->photo)}}" />
                                                </span>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
       <!--/****************************/-->  
        <form class="well form-horizontal" action=" {{url('Admin/'. $admin->id) }} " method="POST"  id="contact_form"> 
        {{ csrf_field() }} 
...
<fieldset>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-9 inputGroupContainer ">
                          <div class="input-group"  style="width: 40%">
                            <input  name="nom" class="form-control" value="{{$admin->name}}" type="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 inputGroupContainer">
                          <div class="input-group"  style="width: 40%">
                            <input  name="prenom" value="{{$admin->prenom}}" class="form-control"  type="text">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-6 inputGroupContainer input-group Date">
                              <input name="date_naissance" type="text" class="form-control pull-right" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask id="datepicker" value="{{$admin->date_N}}">
                            </div>
                      </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                              <label class="col-md-6 control-label">Sexe</label>  
                                ...
                                <div class="col-lg-12">
                                    <div class="i-checks pull-left">
                                       <label>
                                       <input type="radio" checked="" value="{{$admin->sexe}}" name="sexe"> <i></i>{{$codeur->sexe}}
                                       </label>
                                    </div>
                                </div>
                                </div>
              ...
              <a href="{{ url('Admin/'.$admin->id.'/details')}}" class=" btn btn-lg btn-default"><i class="fa  fa-mail-reply"></i> &nbsp;Annuler</a>
               <button type="submit" class=" btn btn-lg btn-primary"><i class="fa fa-check"></i> Modifier</button> 
                            ...
                            <div class="inline pos-rel col-md-3 element-animate">
                                <div class="user ">
                                    ...
                                    <img src="{{asset($enseignant->photo)}}" alt="Image"  title="{{$enseignant->name}} {{$enseignant->prenom}}" class="img-thumbnail img-responsive img-circle" id="photo" 
                                      >                            
                                </div>
                                
                                <div class="body">
                                                            <div class="name">
                                                                <a href="{{ url('enseignant/'.$enseignant->id.'/details')}}">
                                ...
                                <div class="popover">
                                                            ...
                                                            <div class="popover-content">
                                                                <div class="bolder">{{$enseignant->role}}</div>

                                                                <div class="time">
                                                                    <i class="fa fa-envelope middle bigger-120 orange"></i>
                                                                    <span class="green"> {{$enseignant->email}} </span>
                                                                </div>

                                                                <div class="hr dotted hr-8"></div>

                                                                <div class="tools ">
                                                                   <a href="{{ url('enseignant/'.$censeignant->id.'/details')}}">
