...
@section('title','GBS | Details d un ResponsableCodage')
@section('cssHeader')
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 center">
                                                <span class="profile-picture">
                                                    <img class="editable img-responsive" alt="Alex's Avatar" src="{{asset($codeur ->photo)}}" />
                                                </span>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <h4 class="blue">
                                                    <span class="middle">{{$codeur ->nom}} {{$codeur ->prenom}}</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3 center">
                                                <span class="profile-picture">
                                                    ...
                                                    class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="{{asset($codeur ->photo)}}" />
                                                </span>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
       <!--/****************************/-->  
        <form class="well form-horizontal" action=" {{url('ResponsableCodage/'. $codeur ->id) }} " method="POST"  id="contact_form"> 
        {{ csrf_field() }} 
...
<fieldset>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-9 inputGroupContainer ">
                          <div class="input-group"  style="width: 40%">
                            <input  name="nom" class="form-control" value="{{$codeur->nom}}" type="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 inputGroupContainer">
                          <div class="input-group"  style="width: 40%">
                            <input  name="prenom" value="{{$codeur->prenom}}" class="form-control"  type="text">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-md-6 inputGroupContainer input-group Date">
                              <input name="date_naissance" type="text" class="form-control pull-right" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask id="datepicker" value="{{$codeur->date_N}}">
                            </div>
                      </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                              <label class="col-md-6 control-label">Sexe</label>  
                                ...
                                <div class="col-lg-12">
                                    <div class="i-checks pull-left">
                                       <label>
                                       <input type="radio" checked="" value="{{$codeur->sexe}}" name="sexe"> <i></i>{{$codeur->sexe}}
                                       </label>
                                    </div>
                                </div>
                                </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">E-Mail</label>  
                          <div class="col-md-9 inputGroupContainer">
                            <div class="input-group"  style="width: 40%">
                                <input name="email" type="email" class="form-control" value="{{$codeur->email}}">
                        ...
                        <label class="col-md-3 control-label">N° Téléphone</label>  
                          <div class="col-md-9 inputGroupContainer">
                            <div class="col-md-6 input-group" style="width: 40%">
                                <input name="num_tel" type="text" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask value="{{$codeur->num_tel}}">
                              </div>
                          </div>
                    </div>
                     <br><br>
              ...
              <a href="{{ url('ResponsableCodage/'.$codeur->id.'/details')}}" class=" btn btn-lg btn-default"><i class="fa  fa-mail-reply"></i> &nbsp;Annuler</a>
                 ...
                 <div class="itemdiv memberdiv">
                        ...
                        <div class="inline pos-rel col-md-3 element-animate">
                            <div class="user ">
                                ...
                                <img src="{{asset($codeur->photo)}}" alt="Image"  title="{{$codeur->name}} {{$codeur->prenom}}" class="img-thumbnail img-responsive img-circle" id="photo" 
                                  >                            
                            </div>
                            
                            <div class="body">
                                                        <div class="name">
                                                            <a href="{{ url('ResponsableCodage/'.$codeur->id.'/details')}}">
                                                                <span class="user-status status-online"></span>
                                                                {{$codeur->nom}}{{$codeur->prenom}}
                                                            </a>
                                                        </div>
                            </div>
                            ...
                            <div class="popover">
                                                        ...
                                                        <div class="popover-content">
                                                            <div class="bolder">{{$codeur->role}}</div>

                                                            <div class="time">
                                                                <i class="fa fa-envelope middle bigger-120 orange"></i>
                                                                <span class="green"> {{$codeur->email}} </span>
                                                            </div>
