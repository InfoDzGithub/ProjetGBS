...
@section('title','GBS | Listes des ResponsableCodage')
...
@section('content')     
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Liste <span class="table-project-n">des ResponsableCodage</span>:</h1>
                                        <div class="sparkline13-outline-icon">
                                            <div class="button-style-four btn-mg-b-10">
                                                <form action="{{url('ResponsableCodage/create')}}">
                                                   <button type="submit" class="btn btn-custon-four btn-success">Ajouter un nouveau ResponsableCodage
                                                   </button>
                                                </form> 
                                            </div>
                                        </div>
                ...
                <tr>
                    ...
                    <td>{{$codeur->sexe}}</td>
                    <td>{{$codeur->email}}</td>
                    <td>{{$codeur->num_tel}}</td>
                    <td>
                     <div class="btn-group">
          <form action="{{ url('ResponsableCodage/'.$codeur->id)}}" method="post">
              {{csrf_field()}}
              {{method_field('DELETE')}}
               
              <a href="{{ url('ResponsableCodage/'.$codeur->id.'/details')}}" class="btn btn-info">
                <i class="fa fa-eye"></i>
              </a>
                       
              <a href="{{ url('ResponsableCodage/'.$codeur->id.'/edit')}}" class="btn btn-default">
                <i class="fa fa-edit"></i>
              </a>
                      
              <a href="#supprimer{{ $codeur->id }}Modal" role="button" class="btn btn-danger" data-toggle="modal"><i class="fa fa-trash-o"></i>
              </a>
              <div id="supprimer{{ $codeur->id }}Modal" class="modal modal-adminpro-general FullColor-popup-DangerModal PrimaryModal-bgcolor fade" role="dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                     ...
                                     <div class="modal-footer">
                                      <form class="form-inline" action="{{ url('$codeur->id')}}"  method="POST">
                                          @method('DELETE')
                                          @csrf
