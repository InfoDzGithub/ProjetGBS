...
@section('title','GBS | Liste Des Groupes')
               ...
               <div class="container-fluid">
                                ...
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                       <div class="sparkline13-outline-icon">
                                        ...
                                        <h1>Liste <span class="table-project-n">des Groupes</span></h1>
                                        <div class="sparkline13-outline-icon">
                                            <div class="button-style-four btn-mg-b-10">
                                                <form action="{{url('groupe/create')}}"> 
                                                   <button type="submit" class="btn btn-info">Ajouter des nouveaux Groupes
                                                   </button>
                                                </form> 
                                            </div>
                                        </div>
                                        ...
                                        <table code="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-code-table="savecode" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="prenom" data-editable="true">Nom</th>
                                                    <th data-field="dateN" data-editable="true">ID_Promot</th>
                                                   
                                                    <th data-field="promot" data-editable="true">nombre d'etudiants</th>
                ...
                <tr>
                    ...
                    <td>{{$groupe->nomGroup}}</td>
                     <td>{{$groupe->promots_id}}</td>
                    @foreach($nbr as $nbrs)
                    @if($nbrs->groupes_id == $groupe->id)
...
<td> <div class="btn-group">
        <form action="{{ url('groupe/'.$groupe->id)}}" method="post">
              {{csrf_field()}}
              {{method_field('DELETE')}}
              <a href="#supprimer{{ $groupe->id }}Modal" role="button" class="btn btn-danger" data-toggle="modal"><i class="fa fa-trash-o"></i>
              </a>
              <div id="supprimer{{ $groupe->id}}Modal" class="modal modal-adminpro-general FullColor-popup-DangerModal PrimaryModal-bgcolor fade" role="dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                     ...
                                     <div class="modal-footer">
                                      <form class="form-inline" action="{{ url('$groupe->id')}}"  method="POST">
                                          @method('DELETE')
                                          @csrf
