...
<form  action=" {{url('etudiant/'. $etudiant->id) }} " method="POST" enctype="multipart/form-data"  id="contact_form"> 
        {{ csrf_field() }} 
         ...
         <div class="row">
                                            <div class="col-xs-12 col-sm-3 center">
                                                <span class="profile-picture">
                                                    ...
                                                    class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="{{asset($etudiant->photo)}}" />
                                                </span>
    ...
    <fieldset class="well form-horizontal">
                    ...
                    <!--dateN-->
                      <div class="form-group">
                            <label class="col-md-3 control-label">Date_Naissance</label>  
                            <div class="col-md-9 inputGroupContainer ">

                            <div class="input-group"  style="width: 40%">
                              <input name="date_naissance" type="date" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask id="datepicker" value="{{$etudiant->dateN}}">
                            </div>
                      </div>
                      </div>
                    <br><br>
