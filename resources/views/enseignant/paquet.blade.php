                        ...
                        <div id="composemail" class="tab-pane fade in animated zoomInDown shadow-reset custom-inbox-message active">
                            <div >
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <form action="{{url('note/'.$idP.'/'.$idE)}}" method="GET" enctype="multipart/form-data">
                                        ...
                                        <tbody>
                                          ...
                                          @foreach($paquet as $P)
                                            <tr>
                                                <td></td>
                                                <td>{{$P->id}}</td>
                                                <td class="datatable-ct">{{$P->code}}</td>
                                                <td>@if($Aff==1)
                                                    <input type="number" name="{{$P->id}}" value="{{$P->noteC1}}"max="20">
                                                    @elseif($Aff==3)
                                                    <input type="number" name="{{$P->id}}" value="{{$P->noteC2}}"max="20">
                                                    @elseif($Aff==5)
                                                    <input type="number" name="{{$P->id}}" value="{{$P->noteC3}}"max="20">
                                                    @endif
                                                </td>
                                    ...
                                    <button type="submit" align="right" class="btn btn-primary">Validé</button>
                                    </form>
                                </div>
                            </div>
                        </div>
